    ...
    <div className="min-h-screen bg-[#050b18] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <h1 className="text-4xl font-black tracking-tighter uppercase mb-4 leading-none">
          SYSTEM <span className="text-gradient-primary">SYNCED.</span>
        </h1>
        ...
        <div className="space-y-4">
          <Link
            to="/"
            className="group flex items-center justify-center gap-3 w-full py-6 bg-primary text-black font-black uppercase tracking-[0.3em] text-[10px] transition-all duration-500 border border-primary hover:bg-[#99da56]"
          >
            Dashboard Access
          ...
          <div className="text-[9px] text-slate-600 font-bold uppercase tracking-[0.4em] pt-4">
            Transaction ID: #TITON-{Math.random().toString(36).substr(2, 9).toUpperCase()}
          </div>
        </div>
      </motion.div>
    </div>
